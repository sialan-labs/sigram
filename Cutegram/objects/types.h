...
// Command: /home/bardia/Projects/build/AsemanQtObjectCreator/Clone_of_Desktop_Qt_5_3_0_GCC_64bit/Debug/AsemanQtObjectCreator if=/home/bardia/Projects/Cutegram/Cutegram/objects/types.sco of=/home/bardia/Projects/Cutegram/Cutegram/objects/types.h template_class=/home/bardia/Projects/Cutegram/Cutegram/objects/templates/class.template template_equals=/home/bardia/Projects/Cutegram/Cutegram/objects/templates/equals.template template_initialize=/home/bardia/Projects/Cutegram/Cutegram/objects/templates/initialize.template template_file=/home/bardia/Projects/Cutegram/Cutegram/objects/templates/file.template
...
static bool initialize() {
    qmlRegisterType<DownloadObject>("CutegramTypes", 1, 0, "Download");
    qRegisterMetaType<DownloadObject*>("DownloadObject*");

    qmlRegisterType<UploadObject>("CutegramTypes", 1, 0, "Upload");
    qRegisterMetaType<UploadObject*>("UploadObject*");

    qmlRegisterType<FileLocationObject>("CutegramTypes", 1, 0, "FileLocation");
    qRegisterMetaType<FileLocationObject*>("FileLocationObject*");

    qmlRegisterType<PeerObject>("CutegramTypes", 1, 0, "Peer");
    qRegisterMetaType<PeerObject*>("PeerObject*");

    qmlRegisterType<ContactObject>("CutegramTypes", 1, 0, "Contact");
    qRegisterMetaType<ContactObject*>("ContactObject*");

    qmlRegisterType<InputPeerObject>("CutegramTypes", 1, 0, "InputPeer");
    qRegisterMetaType<InputPeerObject*>("InputPeerObject*");

    qmlRegisterType<UserStatusObject>("CutegramTypes", 1, 0, "UserStatus");
    qRegisterMetaType<UserStatusObject*>("UserStatusObject*");

    qmlRegisterType<GeoPointObject>("CutegramTypes", 1, 0, "GeoPoint");
    ...
    qmlRegisterType<ChatParticipantObject>("CutegramTypes", 1, 0, "ChatParticipant");
    qRegisterMetaType<ChatParticipantObject*>("ChatParticipantObject*");

    qmlRegisterType<ChatParticipantsObject>("CutegramTypes", 1, 0, "ChatParticipants");
    qRegisterMetaType<ChatParticipantsObject*>("ChatParticipantsObject*");

    qmlRegisterType<PhotoSizeObject>("CutegramTypes", 1, 0, "PhotoSize");
    qRegisterMetaType<PhotoSizeObject*>("PhotoSizeObject*");

    qmlRegisterType<AudioObject>("CutegramTypes", 1, 0, "Audio");
    qRegisterMetaType<AudioObject*>("AudioObject*");

    qmlRegisterType<DocumentObject>("CutegramTypes", 1, 0, "Document");
    qRegisterMetaType<DocumentObject*>("DocumentObject*");

    qmlRegisterType<VideoObject>("CutegramTypes", 1, 0, "Video");
    qRegisterMetaType<VideoObject*>("VideoObject*");

    qmlRegisterType<PhotoObject>("CutegramTypes", 1, 0, "Photo");
    qRegisterMetaType<PhotoObject*>("PhotoObject*");

    qmlRegisterType<WallPaperObject>("CutegramTypes", 1, 0, "WallPaper");
    qRegisterMetaType<WallPaperObject*>("WallPaperObject*");

    qmlRegisterType<MessageActionObject>("CutegramTypes", 1, 0, "MessageAction");
    qRegisterMetaType<MessageActionObject*>("MessageActionObject*");

    qmlRegisterType<ChatPhotoObject>("CutegramTypes", 1, 0, "ChatPhoto");
    qRegisterMetaType<ChatPhotoObject*>("ChatPhotoObject*");

    qmlRegisterType<ChatFullObject>("CutegramTypes", 1, 0, "ChatFull");
    qRegisterMetaType<ChatFullObject*>("ChatFullObject*");

    qmlRegisterType<UserProfilePhotoObject>("CutegramTypes", 1, 0, "UserProfilePhoto");
    qRegisterMetaType<UserProfilePhotoObject*>("UserProfilePhotoObject*");

    qmlRegisterType<ChatObject>("CutegramTypes", 1, 0, "Chat");
    ...
    qmlRegisterType<MessageObject>("CutegramTypes", 1, 0, "Message");
    qRegisterMetaType<MessageObject*>("MessageObject*");

    qmlRegisterType<GeoChatMessageObject>("CutegramTypes", 1, 0, "GeoChatMessage");
    qRegisterMetaType<GeoChatMessageObject*>("GeoChatMessageObject*");

    qmlRegisterType<UserObject>("CutegramTypes", 1, 0, "User");
