...
AsemanNotification::AsemanNotification(QObject *parent) :
    QObject(parent)
{
    p = new AsemanNotificationPrivate;
...
uint AsemanNotification::sendNotify(const QString &title, const QString &body, const QString &icon, uint replace_id, int timeOut, const QStringList &actions)
{
    QVariantList args;
...
void AsemanNotification::closeNotification(uint id)
{
...
void AsemanNotification::notificationClosed(const QDBusMessage &dmsg)
{
...
void AsemanNotification::actionInvoked(const QDBusMessage &dmsg)
{
    if( dmsg.type() != QDBusMessage::SignalMessage )
        return ;
...
AsemanNotification::~AsemanNotification()
{
    delete p;
}
