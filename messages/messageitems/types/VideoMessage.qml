...
AbstractMessage {
    ...
    Column {
        ...
        ToolKit.MessageImage {
            ...
            engine: videoMsg.engine
            message: videoMsg.message
            maximumWidth: videoMsg.maximumWidth
            maximumHeight: videoMsg.maximumHeight
            blur: !img.downloaded
            ...
            Rectangle {
                ...
                ProgressBar {
                    ...
                    percent: 100*videoMsg.transfaredSize/videoMsg.totalSize
                    visible: videoMsg.transfaring
                }
                ...
                Text {
                    ...
                    text: {
                        ...
                        if(videoMsg.transfaring) {
                            var fileSize = ("%1/%2").arg(trSize(videoMsg.transfaredSize)).arg(trSize(videoMsg.totalSize))
                            time = fileSize + ", " + time
                        }
        ...
        TextEdit {
            id: message_txt
            anchors.horizontalCenter: parent.horizontalCenter
            width: img.width - videoMsg.margins*2
