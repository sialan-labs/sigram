...
#ifndef SIALANCALENDARCONVERTERCORE_H
#define SIALANCALENDARCONVERTERCORE_H
...
class SialanCalendarConverterCore
{
public:
    SialanCalendarConverterCore();
    ~SialanCalendarConverterCore();
...
private:
    SialanCalendarConverterCorePrivate *p;
};

#endif // SIALANCALENDARCONVERTERCORE_H
